...
url: 'conexion.php',
type: 'POST',
data: 'fecha='+fecha+'&hora='+hora+'&contador='+contador,
...
alert("Holils");
var divRedactar = document.getElementById("divlogin");//valor del div   
 divRedactar.innerHTML="<form method=\"post\" class=\"login\"><p>Ingresa el correo al que desea se le envie la contraseña nueva:</p><p><label for=\"login\">Correo:</label><input type=\"email\" name=\"correoR\" id=\"correoR\" placeholder=\"nombre@ejemplo.com\"></p><p class=\"login-submit\"><button type=\"submit\" class=\"login-button\" onClick=\"enviarMensaje()\">Enviar</button></p></form>";
